  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="sources" element={<div className="p-4">Sources page coming soon...</div>} />
        <Route path="destinations" element={<div className="p-4">Destinations page coming soon...</div>} />
