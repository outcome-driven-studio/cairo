  ...
  slack: [
    {
      ...
      description: "Slack webhook URL for event alerts",
      category: "Slack Alerts",
    },
    {
      key: "SLACK_DEFAULT_CHANNEL",
      description: "Default Slack channel for alerts (optional)",
      default: "",
      category: "Slack Alerts",
    },
    {
      key: "SLACK_ALERT_EVENTS",
      ...
      example:
        '{"signup_completed":{"channel":"#new-users"},"payment_succeeded":{"threshold":100}}',
      category: "Slack Alerts",
    },
    {
      key: "SLACK_PAYMENT_THRESHOLD",
      description: "Minimum payment amount to trigger alerts",
      default: "100",
      category: "Slack Alerts",
    },
    {
      key: "SLACK_MAX_ALERTS_PER_MINUTE",
...
class EnvSetup {
  ...
  async fullSetup() {
    ...
    const categories = [
      ...
      { name: "Slack Alerts", items: envConfig.slack },
  ...
  async writeEnvFile() {
    ...
    try {
      ...
      if (
        ...
        this.envVars.DATABASE_URL.includes("localhost")
      ) {
        this.log("\n⚠️  Database Setup Required:", "yellow");
        this.log(
          "Your DATABASE_URL points to localhost. Make sure PostgreSQL is running:"
        );
